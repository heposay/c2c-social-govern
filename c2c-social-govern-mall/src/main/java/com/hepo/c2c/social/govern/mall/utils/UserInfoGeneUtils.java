 ...
 * CreateDate: Created in 2022-09-22 15:55
 *
 * @author linhaibo
 */
public class UserInfoGeneUtils {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10; i++) {
            System.out.println("获取手机号：" + getTel());
            System.out.println("获取中文名：" + getChineseName());
            System.out.println("获取地址：" + getRoad());
            System.out.println("获取邮箱：" + getEmail(9, 12));
            System.out.println("获取完整数据：" + getAddress());
            System.out.println("----------------");
        }
    }
}
